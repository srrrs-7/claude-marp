...
- 孤独は1日15本の喫煙と同等の死亡リスク
- 脳・心臓・免疫系への直接的な生物学的影響
- 21世紀最大の「公衆衛生上の流行病」
...
<div class="fig">
<svg viewBox="0 0 700 210" style="display:block;margin:0 auto;display:block;width:100%;height:100%;max-width:100%;max-height:100%;margin:0 auto;letter-spacing:0;"><rect width="700" height="210" fill="#1a1a2e" rx="10"/><text x="350" y="24" fill="#f9a825" font-size="13" font-weight="bold" text-anchor="middle" font-family="sans-serif">SNS利用時間と孤独感・うつ症状の関係（Twenge &amp; Campbell）</text><rect x="60" y="40" width="20" height="120" fill="#26a69a" rx="3"/><rect x="100" y="60" width="20" height="100" fill="#26a69a" rx="3"/><rect x="140" y="80" width="20" height="80" fill="#f9a825" rx="3"/><rect x="180" y="70" width="20" height="90" fill="#f9a825" rx="3"/><rect x="220" y="55" width="20" height="105" fill="#ff7043" rx="3"/><rect x="260" y="40" width="20" height="120" fill="#ff7043" rx="3"/><rect x="300" y="30" width="20" height="130" fill="#e91e63" rx="3"/><rect x="340" y="20" width="20" height="140" fill="#e91e63" rx="3"/><text x="70" y="175" fill="#aaa" font-size="10" text-anchor="middle" font-family="sans-serif">〜30分</text><text x="150" y="175" fill="#aaa" font-size="10" text-anchor="middle" font-family="sans-serif">1時間</text><text x="230" y="175" fill="#aaa" font-size="10" text-anchor="middle" font-family="sans-serif">2時間</text><text x="310" y="175" fill="#aaa" font-size="10" text-anchor="middle" font-family="sans-serif">3時間+</text><text x="60" y="190" fill="#aaa" font-size="10" text-anchor="middle" font-family="sans-serif">SNS利用時間（1日あたり）</text><rect x="430" y="50" width="14" height="14" fill="#26a69a" rx="2"/><text x="452" y="62" fill="#ccc" font-size="11" font-family="sans-serif">低い孤独感</text><rect x="430" y="80" width="14" height="14" fill="#f9a825" rx="2"/><text x="452" y="92" fill="#ccc" font-size="11" font-family="sans-serif">中程度の孤独感</text><rect x="430" y="110" width="14" height="14" fill="#e91e63" rx="2"/><text x="452" y="122" fill="#ccc" font-size="11" font-family="sans-serif">高い孤独感・うつ症状</text><text x="450" y="155" fill="#aaa" font-size="10" text-anchor="middle" font-family="sans-serif">特に10代女性に顕著</text></svg>
</div>
...
- 対面 vs SNS：脳内ホルモン分泌の比較

<div class="fig">
<svg viewBox="0 0 700 230" style="display:block;margin:0 auto;display:block;width:100%;height:100%;max-width:100%;max-height:100%;margin:0 auto;letter-spacing:0;"><rect width="700" height="230" fill="#1a1a2e" rx="10"/><text x="350" y="26" fill="#f9a825" font-size="13" font-weight="bold" text-anchor="middle" font-family="sans-serif">コミュニケーション形態別の幸福ホルモン分泌量</text><text x="175" y="55" fill="white" font-size="13" font-weight="bold" text-anchor="middle" font-family="sans-serif">対面コミュニケーション</text><rect x="60" y="65" width="90" height="100" fill="#e91e63" opacity="0.9" rx="4"/><rect x="165" y="105" width="90" height="60" fill="#f9a825" opacity="0.9" rx="4"/><text x="105" y="58" fill="#e91e63" font-size="11" text-anchor="middle" font-family="sans-serif">オキシトシン</text><text x="210" y="100" fill="#f9a825" font-size="11" text-anchor="middle" font-family="sans-serif">ドーパミン</text><text x="105" y="178" fill="#ccc" font-size="12" text-anchor="middle" font-family="sans-serif">高分泌</text><text x="210" y="178" fill="#ccc" font-size="12" text-anchor="middle" font-family="sans-serif">高分泌</text><line x1="280" y1="80" x2="430" y2="80" stroke="#555" stroke-width="1" stroke-dasharray="4"/><text x="355" y="76" fill="#aaa" font-size="11" text-anchor="middle" font-family="sans-serif">vs</text><text x="525" y="55" fill="white" font-size="13" font-weight="bold" text-anchor="middle" font-family="sans-serif">SNSのやりとり</text><rect x="440" y="130" width="90" height="35" fill="#7c4dff" opacity="0.7" rx="4"/><rect x="545" y="148" width="90" height="17" fill="#0288d1" opacity="0.7" rx="4"/><text x="485" y="125" fill="#b39ddb" font-size="11" text-anchor="middle" font-family="sans-serif">オキシトシン</text><text x="590" y="143" fill="#80deea" font-size="11" text-anchor="middle" font-family="sans-serif">ドーパミン</text><text x="485" y="178" fill="#ccc" font-size="12" text-anchor="middle" font-family="sans-serif">著しく低い</text><text x="590" y="178" fill="#ccc" font-size="12" text-anchor="middle" font-family="sans-serif">著しく低い</text><text x="350" y="210" fill="#aaa" font-size="11" text-anchor="middle" font-family="sans-serif">COVID-19パンデミック：強制的社会的孤立が孤独・うつ・認知症リスクを世界規模で拡大</text></svg>
</div>
...
- **孤独の死亡リスク = 1日15本喫煙相当（科学的根拠あり）**
- **対面・身体的接触・弱い紐帯の積み重ねが最も効果的**
- 「人間は社会的動物である」— アリストテレス（2400年前の洞察が科学で証明された）

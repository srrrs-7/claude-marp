...
> *完全・無矛盾・決定可能な数学体系を目指したヒルベルトの夢は1931年に崩壊*
...
> *バグ存在の証明は可能だが不在の証明は原理的に不可能—ダイクストラの指摘*
...
> *形式検証は実装の正しさを証明するが仕様の正しさは証明できない、コスト3〜10倍*
...
> *完全性追求を捨てリスクベースで重要箇所に集中することで効率的に信頼を構築する*
...
> *障害を防ぐより壊れても回復できる設計を選ぶ、Netflix Chaos Monkeyが体現*
...
> *全ケース網羅の代わりに性質を1000パターンで確率的に検証し広い信頼を獲得*
...
> *各層が異なる種類の信頼を提供し積み重ねることで完全性の代替を構築する*

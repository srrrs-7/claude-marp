...
-   <!-- row 2: AI展望 -->
-   <rect x="280" y="130" width="240" height="55" rx="8" fill="#16213e" stroke="#e91e63" stroke-width="2"/>
-   <text x="400" y="152" text-anchor="middle" fill="#e91e63" font-size="12" font-weight="bold" font-family="sans-serif">5. AI立法への展望</text>
-   <text x="400" y="170" text-anchor="middle" fill="#ccc" font-size="10" font-family="sans-serif">LLMと法律の未来</text>
-   <!-- connecting lines from row 1 to row 2 -->
-   <line x1="490" y1="101" x2="435" y2="130" stroke="#555" stroke-width="1.5" stroke-dasharray="4,3"/>
-   <line x1="670" y1="101" x2="510" y2="130" stroke="#555" stroke-width="1.5" stroke-dasharray="4,3"/>
-   <!-- bottom conclusion -->
-   <rect x="100" y="210" width="600" height="50" rx="10" fill="#0d0d1a" stroke="#f9a825" stroke-width="1.5"/>
...
```python
# より具体的なスコープが優先
class SpecialLaw(GeneralLaw):  # 特別法
    def rule(self): ...  # オーバーライド
```
...
-   <text x="140" y="223" text-anchor="middle" fill="#888" font-size="10" font-family="monospace">hotfix / runtime patch</text>
-   <rect x="290" y="185" width="220" height="50" rx="8" fill="#0d2137" stroke="#888" stroke-width="1.5"/>
-   <text x="400" y="205" text-anchor="middle" fill="#aaa" font-size="11" font-family="sans-serif">修正方法: 憲法裁判所</text>
-   <text x="400" y="223" text-anchor="middle" fill="#888" font-size="10" font-family="monospace">build error resolution</text>
-   <rect x="550" y="185" width="220" height="50" rx="8" fill="#0d2137" stroke="#888" stroke-width="1.5"/>
-   <text x="660" y="205" text-anchor="middle" fill="#aaa" font-size="11" font-family="sans-serif">修正方法: 法改正</text>
-   <text x="660" y="223" text-anchor="middle" fill="#888" font-size="10" font-family="monospace">refactor / rewrite</text>
-   <line x1="140" y1="150" x2="140" y2="185" stroke="#888" stroke-width="1.5" stroke-dasharray="4,3"/>
-   <line x1="400" y1="150" x2="400" y2="185" stroke="#888" stroke-width="1.5" stroke-dasharray="4,3"/>
-   <line x1="660" y1="150" x2="660" y2="185" stroke="#888" stroke-width="1.5" stroke-dasharray="4,3"/>
-   <polygon points="140,185 134,173 146,173" fill="#888"/>
-   <polygon points="400,185 394,173 406,173" fill="#888"/>
-   <polygon points="660,185 654,173 666,173" fill="#888"/>
-   <!-- caption -->
-   <text x="400" y="265" text-anchor="middle" fill="#aaa" font-size="11" font-family="sans-serif">法律のバグはソフトウェアのバグと同じ構造を持つ — しかし「実行」は社会全体</text>
- </svg>
...
-   <line x1="390" y1="80" x2="520" y2="128" stroke="#4db6ac" stroke-width="2"/>
-   <circle cx="390" cy="80" r="10" fill="#0d2137" stroke="#4db6ac" stroke-width="2"/>
-   <text x="390" y="64" text-anchor="middle" fill="#4db6ac" font-size="10" font-family="sans-serif">法案審議 (PR)</text>
-   <text x="390" y="84" text-anchor="middle" fill="#4db6ac" font-size="9" font-family="monospace">branch</text>
-   <!-- deprecated branch -->
-   <line x1="120" y1="128" x2="200" y2="205" stroke="#888" stroke-width="1.5" stroke-dasharray="5,4"/>
-   <circle cx="200" cy="205" r="8" fill="#1a1a2e" stroke="#888" stroke-width="1.5"/>
-   <text x="200" y="222" text-anchor="middle" fill="#888" font-size="10" font-family="sans-serif">廃止法 (deprecated)</text>
-   <!-- constitution (interface) -->
-   <rect x="60" y="240" width="680" height="36" rx="6" fill="#0d2137" stroke="#f9a825" stroke-width="1.5"/>
-   <text x="400" y="263" text-anchor="middle" fill="#f9a825" font-size="12" font-family="sans-serif">憲法 = interface / 最上位コントラクト（ブランチ削除不可）</text>
-   <!-- time arrow -->
-   <text x="60" y="125" fill="#aaa" font-size="10" font-family="sans-serif">過去</text>
-   <text x="720" y="125" fill="#aaa" font-size="10" font-family="sans-serif">現在</text>
- </svg>
...
| 法案提出 | Pull Request |
| 委員会審議 | Code Review |
| 修正案 | Review Comment → 修正 |
| 本会議採決 | Merge |
| 公布・施行 | Deploy |
| 廃止 | Deprecation |
| 憲法 | Interface / Contract |
...
-   <!-- Step 4: Result -->
-   <rect x="600" y="55" width="170" height="70" rx="8" fill="#16213e" stroke="#e91e63" stroke-width="2"/>
-   <text x="685" y="83" text-anchor="middle" fill="#e91e63" font-size="12" font-weight="bold" font-family="sans-serif">判定結果</text>
-   <text x="685" y="100" text-anchor="middle" fill="#ccc" font-size="10" font-family="sans-serif">compliant / non-compliant</text>
-   <text x="685" y="116" text-anchor="middle" fill="#aaa" font-size="9" font-family="monospace">audit trail生成</text>
-   <!-- benefit boxes below -->
-   <rect x="30" y="168" width="220" height="60" rx="8" fill="#0d2137" stroke="#81c784" stroke-width="1.5"/>
-   <text x="140" y="190" text-anchor="middle" fill="#81c784" font-size="12" font-family="sans-serif">自動コンプライアンス確認</text>
-   <text x="140" y="210" text-anchor="middle" fill="#ccc" font-size="10" font-family="sans-serif">24時間365日、瞬時に判定</text>
-   <rect x="290" y="168" width="220" height="60" rx="8" fill="#0d2137" stroke="#81c784" stroke-width="1.5"/>
-   <text x="400" y="190" text-anchor="middle" fill="#81c784" font-size="12" font-family="sans-serif">透明なルールの適用</text>
-   <text x="400" y="210" text-anchor="middle" fill="#ccc" font-size="10" font-family="sans-serif">同じ条件 → 同じ結果</text>
-   <rect x="550" y="168" width="220" height="60" rx="8" fill="#0d2137" stroke="#81c784" stroke-width="1.5"/>
-   <text x="660" y="190" text-anchor="middle" fill="#81c784" font-size="12" font-family="sans-serif">変更追跡</text>
-   <text x="660" y="210" text-anchor="middle" fill="#ccc" font-size="10" font-family="sans-serif">法改正 → 差分レビュー</text>
-   <!-- caption -->
-   <rect x="60" y="260" width="680" height="40" rx="8" fill="#0d0d1a" stroke="#f9a825" stroke-width="1.5"/>
-   <text x="400" y="278" text-anchor="middle" fill="#f9a825" font-size="12" font-family="sans-serif">NZ・エストニアが実現: 税法・行政手続きをAPI化</text>
-   <text x="400" y="294" text-anchor="middle" fill="#aaa" font-size="10" font-family="sans-serif">市民・企業が直接シミュレーション可能な法律インフラ</text>
- </svg>

...
# 事例4：税務申告不正（IRS活用事例）（2/2）

> *IRSがベンフォード分析で申告書スクリーニングを自動化した*
...
# False Positiveの問題（2/2）

> *文脈理解なしのベンフォード判定が無実の組織を誤検知する*
...
# データ選択の判断基準チェックリスト（2/2）

> *適用前の5項目チェックで誤検知リスクを事前に排除できる*

...
> *ロストテクノロジー→技術喪失パターン→レガシー類似→ドキュメント生存戦略の6章*
...
> *依存ライブラリの脆弱性と知識断絶が放置コストを指数的に増大させる*

...
![マネージメントの影響力](assets/management-impact.svg)
...
![1on1の時間配分](assets/1on1-time-allocation.svg)
...
![SBIAフレームワーク](assets/sbia-framework.svg)
...
![自己決定理論](assets/self-determination.svg)
...
![Googleプロジェクトアリストテレス](assets/google-aristotle.svg)
...
![OKR vs MBO](assets/okr-vs-mbo.svg)
...
![世代別の価値観と特徴](assets/generation-timeline.svg)
...
![心理的安全性 × D&I](assets/psych-safety-di-venn.svg)

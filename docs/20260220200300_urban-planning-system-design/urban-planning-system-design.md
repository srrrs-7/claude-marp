...
> *事前設計の完璧主義がPruitt-Igoe崩壊と同じ失敗をシステムにも引き起こす*
...
![w:750 center](assets/top-down-design.svg)
...
> *観察から生まれた「育まれる街」の思想がバウンデッドコンテキスト設計の原型だ*
...
> *BC内の多様な機能の共存が活力と回復力を生み単一用途分割は脆弱さを招く*
...
> *ユーザーが踏み固めた経路を先に観察してから設計に取り込むことが失敗を防ぐ*
...
> *動いているシステムへの敬意なき改修は都市の再開発失敗と同じ末路をたどる*
...
> *道路増設が渋滞を増やすブラヒェスの逆説はスレッドプール増強でも再現される*
...
> *観察・適応・多様性・下位互換の4原則が都市もシステムも持続させる*

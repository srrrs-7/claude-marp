...
> *800人の中央値が実際の牛体重と誤差0.8%、個人の誤差が打ち消し合い真値に収束*
...
> *多様性・独立性・分散化・集約の4条件を1つでも欠くと集合知は群集心理に転落する*
...
> *ランキング表示だけで世界ごとに人気曲が激変、社会的影響が品質より強く結果を左右する*
...
> *SNSのengagement最適化で異なる声が排除されフィルターバブルが集合知の前提を破壊する*
...
> *AI生成コンテンツがWebに還流しModel Collapseが5世代で多様性を崩壊させる*
...
> *4条件を1つも満たさない投票は組織的操作で暴走し集合知とは無関係の結果になる*
...
> *シニアの最初のコメントが後続レビューを支配するアンカリング—独立レビュー方式で解決*
...
> *見せ合い方式で声の大きいメンバーに全員が引きずられる—同時公開で独立性を回復する*
...
> *AI提案を先に見ると人間の独立思考が失われる、自分の答えを持ってからAIに相談する*
...
> *独立性・多様性・分散化・集約を意図的に設計しなければ集合知は群集心理に堕落する*
...
> *Surowiecki・Salganik・Shumailovの3研究が集合知の条件を実証する基盤*
...
> *GaltonとPariserがそれぞれ集合知の原点とフィルターバブルを定義した*

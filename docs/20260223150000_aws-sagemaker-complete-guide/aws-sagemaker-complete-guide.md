...
> *MLOps・推論・セキュリティの3領域が試験の重点カバー範囲*
...
> *300+変換をGUIで実行—前処理コードをゼロにして時間を80%削減*
...
> *Wrangler=前処理、FeatureStore=再利用、GroundTruth=ラベリング*
...
> *Llama・Stable Diffusion等をワンクリックでデプロイ可能*
...
> *AutoMLで最良アルゴリズムを自動選択—手動比較作業が不要*
...
> *Bias検出+SHAP説明可能性を1サービスで提供—規制対応に必須*
...
> *Pending→Approved→Rejectedで本番デプロイを承認フロー管理*
...
> *4種類の監視を全て有効化—未検知ドリフトは精度劣化の根本原因*
...
> *TargetTrackingでInvocationsPerInstanceをターゲットに自動拡縮*
...
> *MaxConcurrentTransforms調整でスループット最大化が可能*
...
> *TF/PyTorch/ONNXをエッジ向けコンパイルで最大2倍高速化*
...
> *暗号化+VPC+PrivateLink+監査ログの4点が必須要件*
...
> *Spot+Savings Plans+Auto停止で学習コストを最大90%削減*
...
> *Feature Store・Pipelines・Clarifyが最頻出サービス群*
...
> *Blue/Green vs Canary vs Shadowの使い分けが必出問題*
...
> *公式Workshop+Udemyで合格者の80%が学習ルートを統一*

...
> *ジレンマ→プラットフォーム戦争→3E→繰り返しゲーム→標準化の6章*
...
> *最初は協調し裏切りには報復—単純戦略が長期最強*

![w:800 center](assets/svg-pd-tit-for-tat.svg)

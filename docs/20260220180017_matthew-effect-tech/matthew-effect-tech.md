...
> *初期の小さな差が指数的に拡大し格差を固定化する累積優位のメカニズム*
...
> *Google・Meta・AWS・iOSが20年超シェアを維持する臨界質量突破の構造*
...
> *上位1%がコード大多数を生産し「スター数」がさらにスターを呼ぶ*
...
> *データ→AI精度→UX→ユーザー増の循環が止められない独占を作る*
...
> *著名VCの出資シグナルが連鎖し、誰に投資されるかが成否を決める現実*
...
> *初期キャリアの選択が30年後の年収を左右するシグナリング問題*
...
> *Log4Shell示す通り1人のボランティアが世界インフラを支える構造欠陥*
...
> *GSoC・Sponsorsが逆マタイ効果として格差拡大を構造的に抑制する*
...
> *EU DMAとDOJ判決は事後対応に過ぎず、構造的解決にはならない*
...
> *ActivityPub・Blueskyが中央集権の累積優位を構造的に防ぐ試み*

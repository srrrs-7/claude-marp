...
- 一つだったインターネットが国ごとに分裂しつつある
- グレートファイアウォール・主権インターネット・デジタル封建制
- 開かれたウェブの未来は？
...
# 「一つのインターネット」という幻想（1/2）

<div class="fig">
<svg viewBox="0 0 800 260" style="display:block;margin:0 auto;display:block;width:100%;height:100%;max-width:100%;max-height:100%;margin:0 auto;letter-spacing:0;"><rect width="800" height="260" fill="#1a1a2e"/><text x="400" y="30" text-anchor="middle" fill="#f9a825" font-size="15" font-weight="bold" font-family="sans-serif">1990年代の理想：ボーダーレスな情報流通</text><rect x="60" y="55" width="680" height="80" rx="12" fill="#0d47a1" stroke="#42a5f5" stroke-width="2"/><text x="400" y="90" text-anchor="middle" fill="#fff" font-size="16" font-weight="bold" font-family="sans-serif">グローバルインターネット</text><text x="400" y="115" text-anchor="middle" fill="#90caf9" font-size="13" font-family="sans-serif">国境を超えた自由な情報の流れ — すべての人が同じWebにアクセス</text><text x="180" y="175" text-anchor="middle" fill="#a5d6a7" font-size="12" font-family="sans-serif">米国</text><text x="320" y="175" text-anchor="middle" fill="#a5d6a7" font-size="12" font-family="sans-serif">欧州</text><text x="480" y="175" text-anchor="middle" fill="#a5d6a7" font-size="12" font-family="sans-serif">アジア</text><text x="620" y="175" text-anchor="middle" fill="#a5d6a7" font-size="12" font-family="sans-serif">その他</text><line x1="400" y1="135" x2="180" y2="160" stroke="#42a5f5" stroke-width="1"/><line x1="400" y1="135" x2="320" y2="160" stroke="#42a5f5" stroke-width="1"/><line x1="400" y1="135" x2="480" y2="160" stroke="#42a5f5" stroke-width="1"/><line x1="400" y1="135" x2="620" y2="160" stroke="#42a5f5" stroke-width="1"/><text x="400" y="220" text-anchor="middle" fill="#f9a825" font-size="13" font-family="sans-serif">「インターネットは検閲に耐性を持つよう設計されている」— John Gilmore（EFF）</text></svg>
</div>
...
<div class="fig">
<svg viewBox="0 0 800 360" style="display:block;margin:0 auto;display:block;width:100%;height:100%;max-width:100%;max-height:100%;margin:0 auto;letter-spacing:0;"><rect width="800" height="360" fill="#1a1a2e"/><text x="400" y="30" text-anchor="middle" fill="#f9a825" font-size="16" font-weight="bold" font-family="sans-serif">グレートファイアウォール（黄金の盾）の仕組み</text><rect x="30" y="55" width="140" height="60" rx="8" fill="#0d47a1" stroke="#42a5f5" stroke-width="2"/><text x="100" y="80" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold" font-family="sans-serif">中国国内ユーザー</text><text x="100" y="100" text-anchor="middle" fill="#90caf9" font-size="11" font-family="sans-serif">14億人</text><rect x="230" y="45" width="160" height="80" rx="8" fill="#c62828" stroke="#ef9a9a" stroke-width="2"/><text x="310" y="72" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold" font-family="sans-serif">DPI検査</text><text x="310" y="92" text-anchor="middle" fill="#ffcdd2" font-size="10" font-family="sans-serif">ディープパケット</text><text x="310" y="107" text-anchor="middle" fill="#ffcdd2" font-size="10" font-family="sans-serif">インスペクション</text><rect x="460" y="45" width="160" height="80" rx="8" fill="#c62828" stroke="#ef9a9a" stroke-width="2"/><text x="540" y="72" text-anchor="middle" fill="#fff" font-size="13" font-weight="bold" font-family="sans-serif">DNS汚染</text><text x="540" y="92" text-anchor="middle" fill="#ffcdd2" font-size="10" font-family="sans-serif">ブロック済みドメイン</text><text x="540" y="107" text-anchor="middle" fill="#ffcdd2" font-size="10" font-family="sans-serif">の名前解決を妨害</text><rect x="630" y="55" width="140" height="60" rx="8" fill="#1b5e20" stroke="#66bb6a" stroke-width="2"/><text x="700" y="80" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold" font-family="sans-serif">中国内サービス</text><text x="700" y="100" text-anchor="middle" fill="#a5d6a7" font-size="11" font-family="sans-serif">通過OK</text><rect x="630" y="160" width="140" height="60" rx="8" fill="#880e4f" stroke="#f48fb1" stroke-width="2"/><text x="700" y="185" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold" font-family="sans-serif">外部サービス</text><text x="700" y="205" text-anchor="middle" fill="#f8bbd0" font-size="11" font-family="sans-serif">ブロック</text><polygon points="170,85 228,85" fill="none" stroke="#42a5f5" stroke-width="2"/><polygon points="222,80 230,85 222,90" fill="#42a5f5"/><polygon points="390,85 458,85" fill="none" stroke="#42a5f5" stroke-width="2"/><polygon points="452,80 460,85 452,90" fill="#42a5f5"/><polygon points="620,78 628,78" fill="none" stroke="#66bb6a" stroke-width="2"/><polygon points="622,73 630,78 622,83" fill="#66bb6a"/><polygon points="620,105 700,160" fill="none" stroke="#e91e63" stroke-width="2"/><polygon points="694,155 702,162 697,169" fill="#e91e63"/><text x="400" y="185" text-anchor="middle" fill="#f9a825" font-size="14" font-weight="bold" font-family="sans-serif">ブロック対象（主要）</text><rect x="50" y="205" width="180" height="30" rx="4" fill="#37474f"/><text x="140" y="225" text-anchor="middle" fill="#fff" font-size="11" font-family="sans-serif">Google / YouTube / Gmail</text><rect x="250" y="205" width="180" height="30" rx="4" fill="#37474f"/><text x="340" y="225" text-anchor="middle" fill="#fff" font-size="11" font-family="sans-serif">Facebook / Instagram</text><rect x="450" y="205" width="180" height="30" rx="4" fill="#37474f"/><text x="540" y="225" text-anchor="middle" fill="#fff" font-size="11" font-family="sans-serif">Twitter/X / WhatsApp</text><rect x="150" y="255" width="180" height="30" rx="4" fill="#37474f"/><text x="240" y="275" text-anchor="middle" fill="#fff" font-size="11" font-family="sans-serif">Wikipedia（全言語）</text><rect x="350" y="255" width="180" height="30" rx="4" fill="#37474f"/><text x="440" y="275" text-anchor="middle" fill="#fff" font-size="11" font-family="sans-serif">NYT / BBC / Reuters</text><text x="400" y="330" text-anchor="middle" fill="#ef9a9a" font-size="13" font-family="sans-serif">170万件以上のWebサイトをブロック — 世界最大規模</text></svg>
</div>

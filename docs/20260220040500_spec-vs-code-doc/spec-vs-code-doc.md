...
> *6パートで仕様書文化とコード文化の対立から統合まで体系的に解説*
...
# 本当の問題: ドキュメントの「目的」が定義されていない（1/2）（2/2）
...
# 本当の問題: ドキュメントの「目的」が定義されていない（2/2）（2/2）
...
# Living Documentation と Executable Spec（1/2）（2/2）
...
# Living Documentation と Executable Spec（2/2）（2/2）

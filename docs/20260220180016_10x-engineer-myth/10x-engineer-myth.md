...
> *n=12の小規模実験を「10倍神話」に拡大解釈した研究の起源*
...
> *コード行数は不適切な指標、削除したコードが最大貢献かもしれない*
...
> *Copilotで全員が底上げされ、10倍→3倍・1倍→2倍に相対差が縮小*
...
> *コード生成がAIに代替される今、問題定義力が差別化要因になる*
...
> *採用基準をコミュニケーション・学習意欲・ドメイン適合度に切り替える*

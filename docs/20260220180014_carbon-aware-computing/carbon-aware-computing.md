...
> *Googleは深夜シフトで非即時ジョブのCO2を40%削減した*
...
> *OSSのSDKで複数グリッドの炭素強度を統一APIで取得できる*
...
> *AWS・GCP・AzureがCO2可視化ダッシュボードを標準提供済み*
...
> *SCI指標をCI/CDに組み込んで炭素リグレッションを検出する*
...
> *高速コードは省エネコードでもある — アルゴリズム改善が直接CO2削減*
...
> *精度+1%のために10倍のCO2を出す巨大モデルは正当化できない*

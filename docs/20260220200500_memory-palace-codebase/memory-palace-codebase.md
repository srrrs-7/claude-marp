...
> *人間の脳は「場所と紐づけた記憶」を最も効率よく保持するように進化した*
...
# 「コードベースを知っている」とは何か（2/2）

> *歩き回りやすい建物か迷路かがコードベースの質を決める*
...
> *README・index・命名規則が宮殿のランドマークになる*
...
> *空間的に整理されたコードベースが開発者の認知負荷を根本的に下げる*

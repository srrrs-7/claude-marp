...
> *Init→Invoke→Shutdownの三段階でコンテキスト再利用を理解*
...
> *SnapStart対応のJava/DotNETがコールドスタート問題を解消*
...
> *Graviton2採用でx86比コスト20%削減・性能19%向上*
...
> *Pythonが最速・Javaが最遅—SnapStartでJavaを逆転できる*
...
> *Application Auto Scalingで時間帯別に自動スケールして節約*
...
> *OIDC認証・カスタムドメイン・単純ルーティングはHTTP APIで十分*
...
> *コールドスタート許容・実行時間15分以内がLambda適用条件*
...
> *Duration/Error/Throttle/ConcurrentExecutionsの4指標を監視*
...
> *JSON構造化ログ+Lambda文脈自動付加でログ検索を高速化*

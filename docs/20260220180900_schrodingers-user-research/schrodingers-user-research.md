...
<!--
このプレゼンテーションは、量子力学の観測問題とユーザーリサーチの根本的な困難を結びつけて考える試みです。
-->
...
![w:740 center](assets/research-distortion-radar.svg)

<!--
定性調査は深い洞察を提供するが観測歪みが大きい。定量データは表面的だが観測歪みが小さい。理想は両者を組み合わせること。
-->
...
# アナリティクス：「弱い観測」としての行動ログ

![w:700 center](assets/analytics-flow.svg)

<!--
アナリティクスは「弱い測定」の典型。ユーザーはログが取られていることを普段意識しない。そのため自然な行動に最も近いデータが得られる。ただしイベント設計自体にバイアスが入りうる。
-->

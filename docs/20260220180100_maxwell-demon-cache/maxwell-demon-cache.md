...
<!--
Cache-Controlはキャッシュの振る舞いを細かく制御できる。stale-while-revalidateはマクスウェルの悪魔の「古い情報を使いながら更新」戦略に対応
-->

---

# ETagsと条件付きリクエスト：賢い検証メカニズム

...
// L1 cache hit:   ~1ns     (baseline)
// L2 cache hit:   ~5ns     (5x slower)
// L3 cache hit:   ~20ns    (20x slower)
// Main memory:    ~100ns   (100x slower)
// SSD:            ~100μs   (100,000x slower)
// Network:        ~1ms     (1,000,000x slower)
```

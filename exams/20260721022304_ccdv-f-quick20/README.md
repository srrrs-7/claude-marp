...
| ドメイン | 公式配点 | 本問題集 |
|---|---|---|
| D1 Agents & Workflows | 14.7% | 3 |
| D2 Applications & Integration | 33.1% | 6 |
| D3 Claude Code | 3.1% | 1 |
| D4 Eval, Testing & Debugging | 2.6% | 1 |
| D5 Model Selection & Optimization | 16.8% | 3 |
| D6 Prompt & Context Engineering | 11.0% | 2 |
| D7 Security & Safety | 8.1% | 2 |
| D8 Tools & MCPs | 10.6% | 2 |

## 使い方

1. `exam.ja.md`（または `CCDV-F_Developer_practice_20_ja.pdf`）を時間を計って解く
